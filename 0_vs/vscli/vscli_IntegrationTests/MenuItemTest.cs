...
namespace vscli_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(BohemiaInteractive.vscli.GuidList.guidvscliCmdSet, (int)BohemiaInteractive.vscli.PkgCmdIDList.applyCLIChangesCommand);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "vscli", "BohemiaInteractive.vscli.vscliPackage");
