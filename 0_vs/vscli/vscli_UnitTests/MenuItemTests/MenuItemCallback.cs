...
using BohemiaInteractive.vscli;

namespace vscli_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new vscliPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(BohemiaInteractive.vscli.GuidList.guidvscliCmdSet, (int)BohemiaInteractive.vscli.PkgCmdIDList.applyCLIChangesCommand);
